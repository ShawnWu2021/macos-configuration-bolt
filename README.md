...
* Install the _VirtualBox 6.1.16 Oracle VM VirtualBox Extension Pack_ too (again from: https://www.virtualbox.org/wiki/Downloads). You might get prompted for it after the VirtualBox v6.x install. If not, download the Extension Pack and install it. Go to *File* -> *Preferences* -> *Extensions* Category.
